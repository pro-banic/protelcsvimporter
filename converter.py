...
#todo Umplaute mit cp-1252 formatieren oder wie der shit bei protel simba import heißt
...
def createdefaulttabels():
    ...
    with open("defaultdatatables.csv", "r") as csv_file:
...
def convertlvl1pairtospe():
    ...
    with open("testdaten/testdatensatzpair.csv", "r", errors='ignore') as csv_file:
        csv_reader = csv.reader(csv_file)

        with open("testdaten/testdatenexport-lvl1pairtospe.txt", "w", encoding='cp1252', newline="") as export_file:
            # header schreiben
        ...
        # inhalt schreiben
                ...
                for line in csv_reader:
                    ...
                    line_new = Line_iteration_kundennummer + Line_emptyvalue + Line_mpe + \
                               ...
                               Line_Tel + Line_emptyvalue + Line_Mail + 138 * Line_emptyvalue
